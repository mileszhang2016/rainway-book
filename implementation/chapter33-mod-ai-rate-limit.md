# 第三十三章 限流模块实现：mod_ai_rate_limit
...
本章对应设计篇 [第二十一章 配额与限流设计](../design/chapter12-quota-and-rate-limit.md) 与操作篇 [第二十三章 限流策略配置](../operation/chapter23-rate-limit-config.md)，聚焦数据面实现细节。
