...
本章将给出每个场景的关键代码路径、实现步骤、测试要点，并通过流程图展示跨组件协作关系。阅读本章前，建议先回顾 [第二十七章 代码组织与启动流程](../implementation/chapter27-code-layout-and-startup.md)、[第二十八章 接口层实现：OpenAPI与InnerAPI](../implementation/chapter28-endpoints-implementation.md) 以及 [第三十六章 Conf Agent实现](../implementation/chapter35-conf-agent-implementation.md)。
...
- [第三十六章 Conf Agent实现](../implementation/chapter35-conf-agent-implementation.md)
